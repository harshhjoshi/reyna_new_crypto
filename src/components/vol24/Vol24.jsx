...
import styles from "./vol24.module.scss";
...
const Vol24 = () => {
  ...
  const GET_ALL_CRYPTO_CORENCIES = async () => {
    setLoading(true);
   await APICall.get(
      `${API.MARKET_LIST}order=volume_desc&per_page=1000&page=1&sparkline=false&price_change_percentage=24h`
    )
      .then((response) => {
